  ...
  return (
    <div>
      <div className="main-hero-section w-full grid lg:flex justify-between px-8 sm:px-0">
        <div className="hero-left w-full lg:w-1/2 text-left mt-6 order-2 sm:order-1 sm:mt-40">
        ...
        <div className="hero-right w-full lg:w-1/2 order-1 sm:order-2 mt-10 sm:mt-0">
