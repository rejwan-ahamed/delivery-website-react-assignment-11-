  ...
  return (
    <div>
      <div className="section-1 flex mt-32">
        <div className="hero-left w-1/2 text-left">
        ...
        <div className="hero-right w-1/2">
          <img src="/assets/images/PNG/2.png" alt="" className="w-[30rem]" />
        </div>
      </div>

      <div className="section-2 flex mt-32 mb-32">
        <div className="hero-left w-1/2">
          <img src="/assets/images/PNG/3.png" alt="" className="w-[30rem]" />
        </div>

        <div className="hero-right w-1/2 text-left">
          <h1 className="font-general font-[600] text-4xl">
